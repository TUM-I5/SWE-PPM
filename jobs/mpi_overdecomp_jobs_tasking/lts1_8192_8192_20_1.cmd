#!/bin/bash
#NAME=lts_8192_8192_20_01
#SBATCH -o /dss/dsshome1/lxc0E/ga25qic2/jobs_mpioverdecomp_tasking/output/lts_8192_8192_20_01.%j.%N.out
#SBATCH -D /dss/dsshome1/lxc0E/ga25qic2/Codes/swe-benchmark
#SBATCH -J lts_8192_8192_20_01
#SBATCH --get-user-env
