#!/bin/bash
#NAME=gts_8192_8192_20_small
#SBATCH -o /dss/dsshome1/lxc01/ga84zod2/jobs/output/gts_8192_8192_20_small.%j.%N.out
#SBATCH -D /dss/dsshome1/lxc01/ga84zod2/swe-benchmark
#SBATCH -J gts_8192_8192_20_small
#SBATCH --get-user-env
#SBATCH --clusters=cm2
