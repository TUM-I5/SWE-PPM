#!/bin/bash
#NAME=lts_8192_8192_20_big
#SBATCH -o /dss/dsshome1/lxc01/ga84zod2/jobs/output/lts_8192_8192_20_big.%j.%N.out
#SBATCH -D /dss/dsshome1/lxc01/ga84zod2/swe-benchmark
#SBATCH -J lts_8192_8192_20_big
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
source ~/init.sh
unset KMP_AFFINITY
export GASNET_PHYSMEM_MAX='75 GB'
XSIZE=8192
YSIZE=8192
NAME=lts_8192_8192_20_big
TIME=20
...
PARSTRING_HPX="--resolution-horizontal $XSIZE --resolution-vertical $YSIZE -e $TIME -n $CP --local-timestepping 1 --blocks 64 -o $OUTPUT"
CORESIZE=28
for NODECOUNT in 64
do
