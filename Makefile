...
simulate_upcxx_lts:
	${UPCXX_PATH}/bin/upcxx-run -np 64 ./build/SWE_intel_release_upcxx_hybrid_vec -t 20 -n 20 -x 2048 -y 2048 -o ./output/upcxx_lts -l 1 -w 1
simulate_upcxx_gts:
	${UPCXX_PATH}/bin/upcxx-run -np 56  ./build/SWE_intel_release_upcxx_hybrid_vec -t 20 -n 20 -x 2048 -y 2048 -o ./output/upcxx_gts -l 0 -w 1
simulate_upcxx_test:
...
simulate_charm_lts:
	${CHARM_PATH}/bin/charmrun +p56 ./build/SWE_intel_release_charm_hybrid_vec -t 80 -n 20 -x 2048 -y 2048 -o ./output/charm_lts -l 1 -w 0
simulate_charm_gts:
	${CHARM_PATH}/bin/charmrun +p56 ./build/SWE_intel_release_charm_hybrid_vec -t 20 -n 20 -x 2048 -y 2048 -o ./output/charm_gts -l 0 -w 0
simulate_mpi_lts:
	mpirun -np 56 ./build/SWE_intel_release_mpi_hybrid_vec -t 80 -n 20 -x 2048 -y 2048 -o ./output/mpi_lts1 -l 1 -w 1
simulate_mpi_gts:
	mpirun -np 56 ./build/swe_benchmark_mpi -t 20 -n 20 -x 1024 -y 1024 -o ./output/mpi_gts -l 0 -w 0
simulate_hpx:
...
simulate_hpx_gts:
	 mpirun -np 2 ./build/swe_benchmark_hpx -e 20 -n 20 --resolution-horizontal 2048 --resolution-vertical 2048 -o ./output/hpx_gts --blocks 56 --local-timestepping 0 --write 0
simulate_hpx_lts:
	 mpirun -np 2 ./build/swe_benchmark_hpx -e 80 -n 20 --resolution-horizontal 2048 --resolution-vertical 2048 -o ./output/hpx_lts --blocks 128 --local-timestepping 1 --write 0

simulate_chameleon:
	I_MPI_PIN=1 I_MPI_PIN_DOMAIN=auto OMP_NUM_THREADS=27 OMP_PLACES=cores OMP_PROC_BIND=close mpirun -np 2 ./build/SWE_gnu_release_chameleon_omp_hybrid_vec -t 1000 -n 20 -x 1000 -y 1000 -u 1 -v 1 -o ./mpi -b ${DATA_PATH}/tohoku_gebco_ucsb3_2000m_hawaii_bath.nc -d ${DATA_PATH}/tohoku_gebco_ucsb3_2000m_hawaii_displ.nc -l 1

simulate_chameleon_lts:
	I_MPI_PIN=1 I_MPI_PIN_DOMAIN=auto OMP_NUM_THREADS=27 OMP_PLACES=cores OMP_PROC_BIND=close mpirun -np 2 ./build/swe_benchmark_chameleon -t 20 -n 20 -x 2048 -y 2048 -l 1	-o ./output/chameleon_lts --blocks 1

simulate_chameleon_gts:
	I_MPI_PIN=1 I_MPI_PIN_DOMAIN=auto OMP_NUM_THREADS=28 OMP_PLACES=cores OMP_PROC_BIND=close mpirun -np 2 ./build/swe_benchmark_chameleon -t 20 -n 20 -x 1024 -y 1024 -l 0	-o ./output/chameleon_gts --blocks 28 
simulate_ampi:
...
upcxx_rad:
	scons writeNetCDF=True compiler=intel openmp=true solver=hybrid parallelization=upcxx asagi=false copyenv=true showVectorization=true vectorize=true 
upcxx_debug:
...
chameleon_rad:
	scons writeNetCDF=True compiler=intel solver=hybrid openmp=true parallelization=chameleon copyenv=true showVectorization=true vectorize=false
