...
simulate_upcxx_rad:
	${UPCXX_PATH}/bin/upcxx-run -n 4 ./build/SWE_gnu_release_upcxx_hybrid_vec -t 10 -n 20 -x 1000 -y 1000 -o ./mpi -l 1
simulate_upcxx_test:
...
simulate_mpi_rad:
	mpirun -np 4 ./build/SWE_gnu_release_mpi_hybrid -t 10 -n 20 -x 1000 -y 1000 -o ./mpi -l 1
simulate_hpx:
...
simulate_charm_rad:
	mpirun -n  4 ./build/SWE_gnu_release_charm_hybrid -t 10 -n 20 -x 1000 -y 1000 -o ./mpi -l 1
simulate_charm_test:
...
charm_rad:
	scons writeNetCDF=True openmp=false solver=hybrid parallelization=charm asagi=false  copyenv=true
chameleon:
