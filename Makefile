...
simulate_chameleon:
	I_MPI_PIN=1 I_MPI_PIN_DOMAIN=auto OMP_NUM_THREADS=11 OMP_PLACES=cores OMP_PROC_BIND=close mpirun -np 2 ./build/SWE_gnu_release_chameleon_omp_hybrid_vec -t 1000 -n 20 -x 1000 -y 1000 -u 1 -v 1 -o ./mpi -b ${DATA_PATH}/tohoku_gebco_ucsb3_2000m_hawaii_bath.nc -d ${DATA_PATH}/tohoku_gebco_ucsb3_2000m_hawaii_displ.nc -l 0
...
run_chameleon_test:
	I_MPI_PIN=1 I_MPI_PIN_DOMAIN=auto OMP_NUM_THREADS=11 OMP_PLACES=cores OMP_PROC_BIND=close mpirun -np 2 ./build/SWE_gnu_release_chameleon_omp_hybrid -t 1.0 -n 1 -x 320 -y 320 -l 1 -o ./output/test
