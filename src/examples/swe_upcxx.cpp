...
int main(int argc, char **argv) {
    ...
    std::cout << myUpcxxRank << " | " << leftNeighborRank << " " << rightNeighborRank << " " << bottomNeighborRank
              << " " << topNeighborRank << std::endl;
    /****************************************
    ...
    typedef BlockConnectInterface<upcxx::global_ptr < float>>
    Interface;
