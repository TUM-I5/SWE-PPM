...
void SWE_DimensionalSplittingMpi::setGhostLayer() {
    ...
    //std::cout << myMpiRank<<" | " << iteration << " | "  << getTotalLocalTimestep() << " | "<< isReceivable((Boundary)0) << " | "<< isReceivable((Boundary)1) << " | "<< isReceivable((Boundary)2)<< " | "<< isReceivable((Boundary)3)<<" || "<< isSendable((Boundary)0) << " | "<< isSendable((Boundary)1) << " | "<< isSendable((Boundary)2)<< " | "<< isSendable((Boundary)3)<<"\n";
