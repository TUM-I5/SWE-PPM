...
find_library(CHAMELEON_LIB chameleon HINTS "$ENV{CHAMELEON_PATH}/lib")

list(APPEND chameleon_include_directories $ENV{CHAMELEON_PATH}/include)
...
set(EXAMPLE_FILES ${EXAMPLES}/swe_chameleon.cpp)
